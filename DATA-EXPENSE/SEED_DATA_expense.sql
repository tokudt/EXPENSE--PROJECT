...
VALUES
    (2, 'nguyen_van_an',   'an.nguyen@email.vn',    'VND'),
    (3, 'tran_thi_bich',   'bich.tran@email.vn',    'VND'),
    (4, 'le_minh_khoa',    'khoa.le@email.vn',      'VND');
...
-- Housing children
(1, 1, 'Rent',                'fixed',        0),
(1, 1, 'Home Maintenance',    'variable',     0),
-- Food & Dining children
(1, 2, 'Groceries',           'variable',     0),
(1, 2, 'Restaurants',         'variable',     0),
(1, 2, 'Coffee & Drinks',     'variable',     0),
-- Transport children
(1, 3, 'Fuel',                'semi_variable',0),
(1, 3, 'Grab / Taxi',         'variable',     0),
-- Health children
(1, 4, 'Pharmacy',            'variable',     0),
(1, 4, 'Gym Membership',      'fixed',        0),
-- Entertainment children
(1, 5, 'Streamming Services',  'fixed',        0),
(1, 5, 'Games',               'variable',     0),
-- Utilities children
(1, 7, 'Electricity',         'semi_variable',0),
(1, 7, 'Internet',            'fixed',        0),
(1, 7, 'Water',               'semi_variable',0);

-- Sub-categories for User 2 (tran_thi_bich)
INSERT INTO dbo.categories (user_id, parent_id, name, expense_type, is_system) VALUES
(2, 2, 'Groceries',           'variable',     0),
(2, 2, 'Coffee & Drinks',     'variable',     0),
(2, 3, 'Motorbike Fuel',      'semi_variable',0),
(2, 6, 'Clothing',            'variable',     0),
(2, 6, 'Cosmetics',           'variable',     0),
(2, 7, 'Electricity',         'semi_variable',0),
(2, 7, 'Internet',            'fixed',        0),
(2, 8, 'Online Course',       'fixed',        0);

-- Sub-categories for User 3 (le_minh_khoa)
INSERT INTO dbo.categories (user_id, parent_id, name, expense_type, is_system) VALUES
(3, 1, 'Rent',                'fixed',        0),
(3, 2, 'Groceries',           'variable',     0),
(3, 2, 'Restaurants',         'variable',     0),
(3, 3, 'Grab / Taxi',         'variable',     0),
(3, 5, 'Streamming Services',  'fixed',        0),
(3, 7, 'Electricity',         'semi_variable',0),
(3, 7, 'Internet',            'fixed',        0),
(3, 10,'Emergency Fund',      'fixed',        0);
...
(101, 1, 'Vietcombank Checking',    'CHECKING',     15500000,   NULL,        'VND', 'Vietcombank',     1),
(102, 1, 'Techcombank Savings',     'SAVING',       42000000,   NULL,        'VND', 'Techcombank',     1),
(103, 1, 'VPBank Credit Card',      'CREDIT_CARD',  -3200000,   50000000,    'VND', 'VPBank',          1),
(104, 1, 'Cash Wallet',             'CASH',         1200000,    NULL,        'VND', NULL,               1),

-- User 2: tran_thi_bich
(201, 2, 'BIDV Checking',           'CHECKING',     8700000,    NULL,        'VND', 'BIDV',            1),
(202, 2, 'MB Bank Savings',         'SAVING',       25000000,   NULL,        'VND', 'MB Bank',         1),
(203, 2, 'Sacombank Credit Card',   'CREDIT_CARD',  -1500000,   30000000,    'VND', 'Sacombank',       1),

-- User 3: le_minh_khoa
(301, 3, 'ACB Checking',            'CHECKING',     22000000,   NULL,        'VND', 'ACB',             1),
(302, 3, 'Shinhan Bank Savings',    'SAVING',       60000000,   NULL,        'VND', 'Shinhan Bank',    1),
(303, 3, 'MOMO Wallet',             'CASH',         800000,     NULL,        'VND', 'MoMo',            1);
...
VALUES
-- User 1
(1, 1, 101,  12, 6000000,  'Monthly Apartment Rent',      'MONTHLY',   '2024-01-01', NULL,         '2026-03-01', 1),
(2, 1, 101,  21, 220000,   'Netflix Subscription',        'MONTHLY',   '2023-06-01', NULL,         '2026-03-01', 1),
(3, 1, 101,  23, 265000,   'FPT Internet Monthly',        'MONTHLY',   '2023-01-01', NULL,         '2026-03-01', 1),
(4, 1, 101,  20, 200000,   'Gym California Monthly',      'MONTHLY',   '2024-03-01', NULL,         '2026-03-01', 1),

-- User 2
(5, 2, 201,  34, 180000,   'FPT Internet Monthly',        'MONTHLY',   '2023-09-01', NULL,         '2026-03-01', 1),
(6, 2, 201,  35, 450000,   'Coursera Subscription',       'MONTHLY',   '2025-01-01', NULL,         '2026-03-01', 1),

-- User 3
(7, 3, 301,  37, 7500000,  'Monthly Apartment Rent',      'MONTHLY',   '2024-06-01', NULL,         '2026-03-01', 1),
(8, 3, 301,  43, 265000,   'Internet Viettel Monthly',    'MONTHLY',   '2024-06-01', NULL,         '2026-03-01', 1),
(9, 3, 301,  42, 199000,   'Spotify Premium',             'MONTHLY',   '2024-09-01', NULL,         '2026-03-01', 1);
...
VALUES
-- User 1 — Q1 2026
(1,  1, 'Monthly Total Q1-2026',    'MONTHLY',   '2026-01-01', '2026-01-31', 15000000, 0, 80.00, 1),
(2,  1, 'Food & Dining Jan 2026',   'MONTHLY',   '2026-01-01', '2026-01-31',  3000000, 0, 80.00, 1),
(3,  1, 'Monthly Total Feb-2026',   'MONTHLY',   '2026-02-01', '2026-02-28', 15000000, 0, 80.00, 1),
(4,  1, 'Monthly Total Mar-2026',   'MONTHLY',   '2026-03-01', '2026-03-31', 15000000, 0, 80.00, 1),
(5,  1, 'Q1 2026 Overall',          'QUARTERLY', '2026-01-01', '2026-03-31', 45000000, 0, 85.00, 1),
...
INSERT INTO daily_summaries (daily_summary_id, user_id, summary_date, total_expense, total_income, net_amount)
VALUES
